	...
	<div class="home">
		<div class="home-main">
			...
			<div class="aside-chart">
				<zchart :chartId="chart02.chartId" :options="chart02.chartoptions" style="width:100%;height:48%"></zchart>
				<zchart :chartId="chart03.chartId" :options="chart03.chartoptions" style="width:100%;height:48%"></zchart>
			</div>
			<div class="new-user">
